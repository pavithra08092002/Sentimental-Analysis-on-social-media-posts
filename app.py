...
def main():
	...
	if choice == "Home":
		...
		st.write("Welcome to the Sentimental Analysis in Text App! This application utilizes the power of natural language processing and machine learning to analyze and identify emotions in textual data.")
...
if __name__ == '__main__':
    st.markdown("<h1 style='text-align: center; font-size: 49px; color: #d17c3b;'>Sentimental Analysis on Social Media Posts</h1>", unsafe_allow_html=True)
    main()
